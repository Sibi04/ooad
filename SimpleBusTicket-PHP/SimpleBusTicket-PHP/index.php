    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                We are a team of passionate individuals who are dedicated to providing the best possible bus booking experience for our customers. 
                We believe that travel should be easy and affordable, and we are committed to making that happen.
                 We offer a wide variety of bus tickets to destinations all over the world, and we make it easy to book your tickets online or by phone
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Simple Bus Ticket Booking System | Made by WFS
                        </p>
        </footer>
    </div>
